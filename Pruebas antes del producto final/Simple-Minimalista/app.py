...
# --- Estética general inspirada en Apple / iPadOS ---
BG = "#F5F5F7"
CARD = "#FFFFFF"
CARD_SOFT = "#FAFAFC"
CARD_MUTED = "#F2F2F5"
...
# Nombres de las imágenes reales. Colocalas en:
# Prototipo/assets/productos/
PRODUCT_IMAGE_FILES = {
    "Agua": "agua",
    "Jugo": "jugo",
    "Alfajor": "alfajor",
...
# Todas las imágenes se muestran dentro de exactamente el mismo cuadro.
...
class Aplicacion:
    def __init__(self):
        ...
        # IMPORTANTE: esta versión apunta EXACTAMENTE a la estructura que
        # mostrás en tu captura:
        # Simple-Minimalista/assets/productos/*.png
    ...
    def crear_imagenes_producto(self):
        """Carga obligatoriamente las 6 fotos reales desde assets/productos.

        Esta versión NO tiene fallback visual. Si falta una foto, la aplicación
        se detiene y muestra exactamente qué archivo falta.
        """
        archivos = {
            "Agua": "agua.png",
            "Jugo": "jugo.png",
    ...
    def preparar_imagen_producto(self, ruta):
        """Normaliza cualquier foto al mismo cuadro, sin deformarla."""
    ...
    def sugerir(self):
        ...
        # IMPORTANTE: las combinaciones se calculan acá mismo, usando los
        # precios y el stock actuales de los productos visibles en la app.
        # De esta forma esta pantalla NO depende de sugerir_pares() de modelo.py
        # y reemplazar solamente app.py alcanza para corregir esta función.
        ...
        # Las opciones que mejor aprovechan el presupuesto se muestran primero.
        opciones.sort(key=lambda opcion: (-opcion[4], opcion[0], opcion[1]))

        lineas = []
        for primero, segundo, precio_1, precio_2, total, sobra in opciones:
            # Defensa final: nunca se imprime una combinación inválida.
